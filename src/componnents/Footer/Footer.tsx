...
import './Footer.css';
import footerLogo from '../../assets/images/home/herbal-removebg-preview.png';
            ...
            <div style={mystyle} className="na-footer">
                <div className="na-container">
                    <div className="na-sec1">
                        ...
                        <div className='NA_Footer_paragraph'>
                            <p > معنا فقط يمكنك الحصول على تشحيص وعلاج بالأعشاب الطبيبعة  </p>
                        </div>
                    </div>
                ...
                <div className="na-footer-bottom">
                    <div className='NA_Flex_footer_bottom'>
                        <span> Herbs medcare 2024 © All Rights Reserved </span>
                    </div>
                </div>
            </div>
        </>
